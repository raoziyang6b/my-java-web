		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td width="10%">
									<input type="text" name="quantity" value="${entry.value.buyNum }" maxlength="4" size="10" readonly="readonly">
								</td>
								<td width="15%">
									<span class="subtotal">￥${entry.value.subTotal }</span>
								</td>
								<%-- <td>
									<a href="javascript:deleteCartByPid(${entry.value.product.pid });" class="delete">删除</a>
								</td> --%>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath }/privilege/order?method=submitOrder">
