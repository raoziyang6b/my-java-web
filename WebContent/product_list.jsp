	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
       ...
       <c:forEach var="product" items="${requestScope.productList }">
		<div class="col-md-2" style="height:250px">
			...
			<p>
				<a href="${pageContext.request.contextPath  }/product?method=findProductInfoByPid&pid=${product.pid }" style='color: green'>${product.pname }</a>
			</p>
			<p>
	...
	<div
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
			    <c:forEach var="product" items="${historyList }">
				<li
					style="width: 150px; height: 216; float: left; margin: 0 8px 0 0; padding: 0 18px 15px; text-align: center;"><img
					src="${product.pimage }" width="130px" height="130px" /></li>
				</c:forEach>
			</ul>
