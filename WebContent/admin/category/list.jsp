						...
						<tr
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/category?method=toUpdateCategory&cid=${category.cid }">
										<img
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${pageContext.request.contextPath}/category?method=deleteCategory&cid=${category.cid }">
