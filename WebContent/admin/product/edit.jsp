...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/product?method=updateProduct" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="is_hot">
							<option value="1"  ${product.is_hot eq 1 ?"selected='selected'" :"" }>是</option>
							<option value="0"  ${product.is_hot eq 0 ?"selected='selected'" :"" }>否</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="cid">
						     <c:forEach var="category" items="${categoryList }">
						          <c:choose>
						             <c:when test="${category.cid eq product.cid }">
