...
<HTML>
  ...
  $(document).ready(function(){
	...
	<body>
		<!--  -->
		<form id="${pageContext.request.contextPath}/product?" name="Form1" action="${pageContext.request.contextPath}/product?method=addProduct" method="post" enctype="multipart/form-data">
			&nbsp;
